...
These replace or modify the standard D&D 5e rules:
...
## What the DM Can Expect

- **Prep-light is fine.** A one-page dungeon is plenty. Players will fill in the rest with their own chaos.
- **No railroading needed.** Put things in the world. Let players interact with them. See what happens.
- **XP is your lever.** More dangerous = more XP. Reward cleverness as much as combat.
- **Post a session report.** It keeps the shared history alive. See the [DM Guide]({{ '/dm-guide/' | relative_url }}).
